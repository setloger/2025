### **Неделя 3-4 (8-14 июля): FastAPI и асинхронное программирование (Дни 15-28)**

#### **Дни 15-21: Asyncio и асинхронное программирование**
...
### **Неделя 5-6: Тестирование и архитектура (Дни 29-42)**

#### **Дни 29-35: Профессиональное тестирование с pytest**

- **Теория**: Pytest fixtures, параметризация, моки [^17][^18][^19]
- **Практика**: TDD-разработка с полным покрытием тестами [^6]
- **Проект**: API с 95%+ test coverage
- **Критерии оценки**: Написание качественных тестов и применение TDD


#### **Дни 36-42: Архитектурные паттерны и SOLID**

- **Теория**: Принципы SOLID, паттерны проектирования [^4][^20]
- **Практика**: Рефакторинг кода с применением SOLID принципов
- **Проект**: Система управления пользователями с применением всех SOLID принципов
- **Критерии оценки**: Способность применить все принципы SOLID в комплексе


### **Неделя 7-8: Специализированные навыки (Дни 43-50)**

#### **Дни 43-46: Навыки для специализаций**

**Системный аналитик:**

- **Теория**: UML диаграммы, методы системного анализа, BPMN [^7][^21]
- **Практика**: Создание технической документации и диаграмм [^22]
- **Проект**: Анализ и документирование бизнес-процессов

**ML-инженер:**

- **Теория**: PyTorch, TensorFlow, MLOps практики [^9][^10]
- **Практика**: Создание и деплой ML моделей
- **Проект**: ML пайплайн с автоматическим переобучением

**Data Scientist:**

- **Теория**: Pandas, NumPy, статистический анализ [^11]
- **Практика**: Анализ данных с визуализацией
- **Проект**: Комплексный анализ данных с интерактивными дашбордами
...
- FastAPI официальная документация - для изучения современных API [^16]
...
- Работа со структурами данных (деревья, графы, хеш-таблицы) [^23]
- Алгоритмы сортировки и поиска
- Динамическое программирование средней сложности [^25]
- Задачи на асинхронность и конкурентность [^13]
...
- **Ключевые навыки**: UML диаграммы, анализ требований, BPMN [^7][^8]
- **Инструменты**: Microsoft Visio, JIRA, документирование API [^22]
- **Проект**: Система анализа бизнес-процессов с полной документацией


### **Для ML-инженера**

- **Ключевые навыки**: PyTorch (38 упоминаний в вакансиях), Docker, Git [^9]
- **Инструменты**: MLflow, Apache Airflow, Kubernetes [^10]
- **Проект**: ML пайплайн с автоматическим мониторингом и переобучением


### **Для Data Scientist**

- **Ключевые навыки**: Pandas, NumPy, статистический анализ [^11]
- **Инструменты**: Jupyter Notebook, Matplotlib, Seaborn
- **Проект**: Комплексный анализ данных с предиктивным моделированием


### **Для AI-разработчика**

- **Ключевые навыки**: LLM интеграция, векторные базы данных [^12]
- **Инструменты**: OpenAI API, LangChain, ChromaDB
- **Проект**: AI-ассистент с обработкой естественного языка
...
- Самостоятельное проектирование архитектуры приложений [^29]
- Написание поддерживаемого кода с тестовым покрытием >90% [^18]
- Понимание и применение асинхронного программирования [^3][^2]
- Знание принципов SOLID и паттернов проектирования [^4]


### **Практические навыки**

- Создание production-ready API с FastAPI [^2]
- Оптимизация производительности приложений
- Менторинг junior разработчиков
- Code review и рефакторинг legacy кода


### **Портфолио готово к презентации**

- 4-5 проектов различной сложности с исходным кодом на GitHub
