...
class SimpleLogger:
    ...
    def __init__(self, name: str = 'SimpleLogger'): 
        #Имеет аннотацию типа str, указывающую, что ожидается строковое значение
        """
        ...
        # List['LogHandler'] - это аннотация типа, означающая "список объектов типа LogHandler"
        self.handlers: List['LogHandler'] = [] #Список обработчиков (куда отправлять логи)
